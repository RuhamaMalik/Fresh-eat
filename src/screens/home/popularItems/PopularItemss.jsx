...
const PopularItemss = () => {
    ...
    return (
        <>
            <div className={`sm:min-h-full w-full bg-[var(--bg2)] p-8 sm:p-20 md:p-28 flex flex-col gap-8 `}>
                ...
                <h1 className="text-center text-4xl sm:text-5xl font-black text-[var(--dark)] ">Popular Food Items</h1>
