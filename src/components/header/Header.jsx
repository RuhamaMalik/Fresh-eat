...
const Header = ({ showFixedNavbar }) => {
  ...
  return (
    <>
      ...
      <header className={` ${showFixedNavbar ? `px-6 sm:px-0 slide-bottom fixed top-0  w-[100%] max-w-[1800px] flex justify-between h-[90px]` : 'grid grid-cols-[minmax(100px,200px),1fr] h-[110px] xl:h-[140px]  pl-[40px] w-full '}   items-center bg-[var(--light)]  customIndex3 `} style={{ boxShadow: "var(--box-shadow)" }}>
        {/* LOgo */}
